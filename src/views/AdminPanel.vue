      ...
      <v-row>
        <v-col cols="12" lg="4" md="6" sm="12">
          <v-card class="tile-first-row" color="#FFF0F5">
            <v-card-title class="initials">
              {{ this.user ? this.user.email[0].toUpperCase() : '' }}</v-card-title
            >
        ...
        <v-col cols="12" lg="4" md="6" sm="12">
          <v-card class="tile-first-row" color="#F8F8FF">
            <v-card-title class="initials"
              ><i class="mdi mdi-account-box-plus-outline"></i
            ></v-card-title>
            <v-card-title class="title">Dodaj nowe konto administratora</v-card-title>
            <v-btn @click="router.push('/admin-new-account')"
      ...
      <v-row>
        <v-col cols="12" lg="6" md="6" sm="12">
          <v-card class="tile-second-row" color="#FFF8DC">
            ...
            <v-btn class="edit-btn" @click="router.push('/admin-reservations')"
              >Lista rezerwacji</v-btn
            >
          </v-card>
        </v-col>
