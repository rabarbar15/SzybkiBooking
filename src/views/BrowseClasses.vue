    ...
    <v-container class="container">
      <div class="content">
        ...
        <v-card class="list" v-else>
          <v-divider></v-divider>
          <v-virtual-scroll :items="filteredRooms" height="40rem" item-height="48">
        ...
        <v-dialog v-model="dialog" @keydown.esc="handleEscape" scrollable>
          <v-card class="mx-auto pt-4 text-left" max-width="844">
            <v-card-text>
              <div class="top">
              ...
              <div class="details">
                <ul>
                  <li>
                    <p><strong>Strefa:</strong> {{ selectedRoom.zone }}</p>
                  </li>
                  <li>
                    <p><strong>Ulica:</strong> {{ selectedRoom.street }}</p>
                  </li>
                  <li>
                    <p><strong>Budynek:</strong> {{ selectedRoom.building }}</p>
                  </li>
                  <li>
                    <p>
                      <strong>Jednostka organizacyjna:</strong>
                      {{ selectedRoom.organizationalUnit }}
                    </p>
                  </li>
                  <li>
                    <p><strong>Numer sali:</strong> {{ selectedRoom.roomNumber }}</p>
                  </li>
                  <li>
                    <p>
                      <strong>Liczba miejsc:</strong>
                      {{ selectedRoom.numberOfPlaces }}
                    </p>
                  </li>
                </ul>
              </div>
              ...
              >
                ...
                <v-card-text>
                  ...
                  <span class="issue-info"
                    >Jeśli w wybranej sali coś się zepsuło bądź czegoś brakuje,
                    <br />
                    opisz problem, a my zajmiemy się nim natychmiast.</span
                  >
                </v-card-text>
