...
<template>
  <div class="container">
    ...
    <v-card class="table-mobile" v-if="mobile">
      <v-data-table :items="reservations" item-value="name" :headers="mobileHeaders">
              ...
              <ul>
                <li>
                  <p>
                    ...
                    {{ currentItemDetails.status == 'PENDING' ? 'Oczekująca' : 'Zatwierdzona' }}
                  </p>
                </li>
                <li>
                  <p><strong>Data:</strong> {{ currentItemDetails.date }}</p>
                </li>
                <li>
                  <p><strong>Początek:</strong> {{ currentItemDetails.start }}</p>
                </li>
                <li>
                  <p><strong>Koniec:</strong> {{ currentItemDetails.finish }}</p>
                </li>
                <li>
                  <p><strong>Użytkownik:</strong> {{ currentItemDetails.person }}</p>
                </li>
                <li>
                  <p><strong>Sala:</strong> {{ currentItemDetails.roomNumber }}</p>
                </li>
              </ul>
            </div>
          </v-card-text>
    ...
    <v-card class="table" v-else>
      <v-data-table :items="reservations" item-value="name" :headers="headers">
        <template v-slot:[`item.status`]="{ item }">
          <div>
            <v-chip
              :color="item.status == 'PENDING' ? 'red' : 'green'"
