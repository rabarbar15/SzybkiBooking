...
<template>
  <div class="container">
    <header>
      ...
      <h3 class="info-mobile">
        (Jeśli korzystasz ze smartphona przytrzymaj wybraną godzinę 2-3 sekundy)
      </h3>
    </header>
    ...
    <div class="calendar-container">
      ...
      <FullCalendar
        v-else
        class="calendar-content"
        :options="calendarOptionsMobile"
        ref="calendarRef"
      />
    </div>

    <DialogModal
      :childProp="parentState"
      v-on:changeDialogValue="updateDialogState"
      v-on:form-submitted="handleSubmition"
    />
  </div>
</template>
